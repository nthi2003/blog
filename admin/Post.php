...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="../css/blogv3.css">
    </head>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="post-delete.php?post_id=<?= $post['post_id'] ?>" class="btn btn-danger"><i class="fa-solid fa-xmark"></i></a>
                                    <a href="post-edit.php?post_id=<?= $post['post_id'] ?>" class="btn btn-warning"><i class="fa-solid fa-pen"></i></a>
                                    <?php
                                    if ($post['publish'] == 1) {
                                    ?>
